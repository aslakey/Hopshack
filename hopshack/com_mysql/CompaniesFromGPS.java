...
public class CompaniesFromGPS extends Activity {
	...
	private static String url_comanies_fromGPS = "http://hopshack.com/db_companies_from_location.php";
...
class LoadCompanies extends AsyncTask<Void,Void,Void>{
     ...
     * */
     ...
     protected void onPreExecute() {
         super.onPreExecute();
         pDialog = new ProgressDialog(CompaniesFromGPS.this);
...
//load companies from url
	...
	protected Void doInBackground(Void... arg0) {
	   ...
	   protected void onPostExecute(Void result){
         ...
         * */
		   ListAdapter adapter = new SimpleAdapter(CompaniesFromGPS.this,companyList,
