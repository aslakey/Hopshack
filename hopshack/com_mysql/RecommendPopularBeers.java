...
public class RecommendPopularBeers extends Activity {
	//import classes
	...
	private static String url_popular_beers = "http://hopshack.com/db_recommend_popular.php";
	 ...
	 class LoadBeers extends AsyncTask<Void, Void, Void>{
          ...
          * */
          ...
          protected void onPreExecute() {
              super.onPreExecute();
              pDialog = new ProgressDialog(RecommendPopularBeers.this);
		...
		protected Void doInBackground(Void... arg0) {
            ...
            String jsonStr = sh.makeServiceCall(url_popular_beers, ServiceHandler.GET, params);
 	   ...
 	   protected void onPostExecute(Void result){
             ...
             * */
 		   ListAdapter adapter = new SimpleAdapter(RecommendPopularBeers.this,beerList,
