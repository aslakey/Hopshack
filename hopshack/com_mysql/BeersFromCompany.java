...
public class BeersFromCompany extends Activity {
	//import classes
	...
	//URL to get beers from company
	private static String url_beers_from_company = "http://hopshack.com/db_beers_from_company.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//USING LAYOUT FROM RECCOMMEN_POPULAR_BEERS
		setContentView(R.layout.activity_recommend_popular_beers);
		...
		lv = (ListView) findViewById(R.id.recommendPopularBeers_listView);
	 ...
	 class LoadBeers extends AsyncTask<Void, Void, Void>{
         ...
         * */
         ...
         protected void onPreExecute() {
             super.onPreExecute();
             pDialog = new ProgressDialog(BeersFromCompany.this);
		...
		protected Void doInBackground(Void... arg0) {
           ...
           String jsonStr = sh.makeServiceCall(url_beers_from_company, ServiceHandler.GET, params);
	   ...
	   protected void onPostExecute(Void result){
            ...
            * */
		   ListAdapter adapter = new SimpleAdapter(BeersFromCompany.this,beerList,
