...
public class CompaniesFromCountry extends Activity{
	...
	private static String url_comanies_fromGPS = "http://hopshack.com/db_companies_from_country.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		countryCode = intent.getStringExtra(TAG_COUNTRYCODE);
		Log.d(TAG_COUNTRYCODE, countryCode);
...
class LoadCompanies extends AsyncTask<Void,Void,Void>{
     ...
     * */
     ...
     protected void onPreExecute() {
         super.onPreExecute();
         pDialog = new ProgressDialog(CompaniesFromCountry.this);
...
//load companies from url
	...
	protected Void doInBackground(Void... arg0) {
        ...
        params.add(new BasicNameValuePair(TAG_COUNTRYCODE, countryCode));
	   ...
	   protected void onPostExecute(Void result){
         ...
         * */
		   ListAdapter adapter = new SimpleAdapter(CompaniesFromCountry.this,companyList,
