...
public class FoodPairingStyles extends Activity {
	//import classes
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_food_pairing_styles);
		...
		//grab SearchView
		mSearchView = (SearchView) findViewById(R.id.foodPairingStyles_searchView);
		//grab lv
		lv = (ListView) findViewById(R.id.foodPairingStyles_listView);
		lv.setTextFilterEnabled(true);
	    setupSearchView();
	    ListAdapter adapter = new SimpleAdapter(FoodPairingStyles.this,typeList,
	    ...
	    lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent theIntent = new Intent(getApplicationContext(), RecipeList.class);
