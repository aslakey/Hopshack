...
public class RecommendShack extends Activity {
	//import classes
	...
	private static String url_shack = "http://hopshack.com/db_recommend_from_shack.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_recommend_shack);
		ActionBar actionBar = getActionBar();
		actionBar.setDisplayHomeAsUpEnabled(true);



		//grab random state and type from shack
		HashMap<String, String> random = dbTools.getRandomBeer();
		
		sType = random.get(TAG_TYPE);
		stateCode = random.get(TAG_STATE);
		Log.d("sqlite", sType + " " + stateCode);
		
		if(stateCode != "" && stateCode != "null"){
		     // Hashmap for ListView
	        beerList = new ArrayList<HashMap<String, String>>();
			//grab Views
			lv = (ListView) findViewById(R.id.recommendShack_listView);
			...
			Toast.makeText(getApplicationContext(), "Please fill your shack!", Toast.LENGTH_LONG).show();
		}
	 ...
	 class LoadBeers extends AsyncTask<Void, Void, Void>{
          ...
          * */
          ...
          protected void onPreExecute() {
              super.onPreExecute();
              pDialog = new ProgressDialog(RecommendShack.this);
		...
		protected Void doInBackground(Void... arg0) {
            ...
            params.add(new BasicNameValuePair("stateCode", stateCode));
            // Making a request to url and getting response
            
            String jsonStr = sh.makeServiceCall(url_shack, ServiceHandler.GET, params);
 	   ...
 	   protected void onPostExecute(Void result){
             ...
             * */
 		   ListAdapter adapter = new SimpleAdapter(RecommendShack.this,beerList,
